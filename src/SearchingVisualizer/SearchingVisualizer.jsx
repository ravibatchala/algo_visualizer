...
import { getLinerSearchAnimation, getBinarySearchAnimation } from '../algo/searchAlgorithms';
...
export default class SearchVisualizer extends React.Component {
    ...
    binarySearch() {
        ...
        for (let i = 0; i < animations.length; i++) {
            ...
            const [mid, isEqual, left, right] = animations[i];
            ...
            if (i % 2 === 0) {
                setTimeout(() => {
                    ...
                    midStyle.backgroundColor = isEqual ? "#576115b3" : "#00FF00";
                    if (isEqual)
    ...
    linerSearch() {
        ...
        this.enableButtons(animations.length);
        for (let i = 0; i < animations.length; i++) {
            const [eleIdx, isEqual] = animations[i];
            ...
            if (i % 2 === 0) {
                ...
                setTimeout(() => {
                    eleStyle.backgroundColor = isEqual ? "#576115b3" : "#00FF00";
                    if (isEqual)
